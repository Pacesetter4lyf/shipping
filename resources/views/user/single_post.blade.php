            ...
            <div class="row">
               <div class="col-xl-7 col-lg-8">
                  ...
                  <div class="blog-details">
                     <img class="blog-details-img-1" src="../images/{{$post->imageName}}" alt="">
                     <small class="date">{{$post->updated_at}}  -  {{$post->editedBy}}</small>
                     <h2 class="blog-details-title">{{$post->title}}</h2>
                     <div class="blog-details-body">
                        <p>{{$post->content}}</p>
                        <div class="blog-details-quote">{{$post->content2}}</div>
                        <p>{{$post->content3}}</p>
                     </div>
                  </div>
