               ...
               <div class="col-xl-6 col-lg-6">
                  ...
                  <form method = "post"  action="#">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-12">
                           <div class="form-element"><input name="pickup" type="text" placeholder="Pick up address"></div>
                        </div>
                        <div class="col-lg-12">
                           <div class="form-element"><input name="dropoff" type="text" placeholder="Drop off address"></div>
                        </div>
                        <div class="col-lg-12">
