...
@section('content')
      <!--  hero area start  -->
      <div class="hero-area hero-bg" id="heroHome13">
         <div class="container">
            <div class="row">
                  ...
                  <div class="quote-form-section">
                     ...
                     <form action="#">
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                                <div class="form-element"><input name="weight" type="number" placeholder="Weight in KG"></div>
                           </div>
                            <div class="col-lg-6">
                                <div class="form-element"><input name="distance" type="number" placeholder="Distance in KM"></div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-element"><input name="dropoff" type="text" placeholder="Pick up address"></div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-element"><input name="pickup" type="text" placeholder="Drop off address"></div>
                            </div>
                           <div class="col-lg-12">
