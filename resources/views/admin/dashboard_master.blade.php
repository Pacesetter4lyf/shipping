...
<head>
  ...
  <title>Transpix</title>
  <link rel="icon" type="image/png" href="assets/img/favicon.png" /> 
  <!-- href="{{ ('/home_images/favicon.png') }}" -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/blogs" class="nav-link" onclick = "showfaq()">Blog</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/dash_contact_us" class="nav-link" onclick = "">Contact</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/orders" class="nav-link" onclick = "">Orders</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/about_us" class="nav-link" onclick = "">Setting</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/edit_calculator" class="nav-link" onclick = "">Calculator</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="assets/img/logo.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .99">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item" onclick="showcontact()";>
                <a href="/dash_contact_us" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Contact</p>
                </a>
              </li>
              ...
              <li class="nav-item" onclick="showcontact()";>
                <a href="/edit_calculator" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Calculator</p>
                </a>
              </li>
