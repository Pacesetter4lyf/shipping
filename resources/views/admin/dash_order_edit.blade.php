                    ...
                    <div class="card-body">
                        <form method = 'post'>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td><input type ="value" name = 'status' value = "{{$order->status}}"></td> -->
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td name = 'trackingid' >{{$order->trackingid}}</td> -->
                                        <td><input readonly type ="value" name = 'trackingid' value = "{{$order->trackingid}}"></td>
                            ...
                            <div id="faq-btns" style="margin: 0 auto; text-align:center;">
                                ...
                                <!-- <a style = "margin: 0 auto; font-size: 2rem;" href="/orders?id={{$order->id}}&mode=save">
